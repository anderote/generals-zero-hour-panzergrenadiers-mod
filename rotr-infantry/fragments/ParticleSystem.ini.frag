...
ParticleSystem ShockTrooperTeslaBlast
  Priority = WEAPON_EXPLOSION
  IsOneShot = No
  Shader = ADDITIVE
  Type = PARTICLE
  ...
  InitialDelay = 0.00 0.00
  DriftVelocity = X:0.10 Y:0.20 Z:0.05
  VelocityType = OUTWARD
  VelOutward = 1.25 1.50
  VelOutwardOther = 1.00 22.00
  VolumeType = SPHERE
  VolSphereRadius = 0.25
  IsHollow = Yes
  IsGroundAligned = No
  IsEmitAboveGroundOnly = No
  IsParticleUpTowardsEmitter = No
